  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-4 z-40 rounded-xl bg-[#00A8A8] px-3 py-2.5 text-sm font-semibold text-white shadow-md"
      >
          ...
          <div className="w-full max-w-md rounded-2xl bg-white p-5 shadow-lg">
            {done ? (
              ...
              <>
                ...
                <textarea
                  className="mt-3 w-full rounded-xl border border-[#E2E8F0] p-3 text-sm"
                  rows={4}
                  value={solicitud}
                  onChange={(e) => setSolicitud(e.target.value)}
                  placeholder="Ej. quiero recordatorios por WhatsApp y dos consultorios"
                />
                <label className="mt-3 block text-xs text-[#475569]">
                  Presupuesto estimado (opcional)
                  <input
                    className="mt-1 w-full rounded-xl border border-[#E2E8F0] p-2 text-sm"
                    value={presupuesto}
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-xl bg-[#0B3A6E] py-2.5 text-sm font-semibold text-white disabled:opacity-40"
                >
                  Enviar mi solicitud
                </button>
              </>
